...
import com.annisa.bcs.DetailTraveling_HR;
...
public class Adapter_Traveling_HR extends RecyclerView.Adapter<Adapter_Traveling_HR.ViewHolder> {
    ...
    public Adapter_Traveling_HR(Context context) {
    ...
    @Override
    public Adapter_Traveling_HR.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.traveling_list_item_hr, parent, false);
    ...
    @Override
    public void onBindViewHolder(final Adapter_Traveling_HR.ViewHolder holder, int position) {
        ...
        public ViewHolder(final View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    context.startActivity(new Intent(context, DetailTraveling_HR.class)
