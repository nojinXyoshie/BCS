...
import com.annisa.bcs.Adapter.Adapter_Traveling_HR;
...
public class Fragment_Traveling_HR extends Fragment implements SwipeRefreshLayout.OnRefreshListener{

    FloatingActionButton btn_add_travelling;
    SharedPreferences sharedPreferences;
    public static final String my_shared_preferences = "my_shared_preferences";
    private static final String TAG = Fragment_Traveling_HR.class.getSimpleName();
    ...
    Adapter_Traveling_HR adapter_traveling_hr;
    Spinner status;
    String period;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_traveling_hr, container, false);
        ...
        swipe.post(new Runnable() {
                       ...
                       public void run() {
                           ...
                           adapter_traveling_hr.notifyDataSetChanged();
                           getTravelling();
                       }
                   }
        );
    ...
    private void Dialog(){
        ...
        dialog.setPositiveButton("Search", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                adapter_traveling_hr.getFilter().filter(period);
            }
        });
    ...
    public void getTravelling() {
        adapter_traveling_hr = new Adapter_Traveling_HR(getActivity());
        rv_travelling.setLayoutManager(new GridLayoutManager(getActivity(), 1));
        rv_travelling.setAdapter(adapter_traveling_hr);
        adapter_traveling_hr.getDatas().clear();
        adapter_traveling_hr.notifyDataSetChanged();
        final StringRequest request = new StringRequest(Request.Method.POST, Server.get_traveling, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    adapter_traveling_hr.setDatas(travellingList);
                    adapter_traveling_hr.notifyDataSetChanged();
