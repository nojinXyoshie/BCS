...
public class Fragment_Traveling_TL extends Fragment implements SwipeRefreshLayout.OnRefreshListener{

    FloatingActionButton btn_add_travelling;
    SharedPreferences sharedPreferences;
    public static final String my_shared_preferences = "my_shared_preferences";
    private static final String TAG = Fragment_Traveling_TL.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_traveling_tl, container, false);
    ...
    private void Dialog(){
        ...
        dialog.setPositiveButton("Search", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                adapter_traveling.getFilter().filter(period);
            }
        });
    ...
    public void getTravelling() {
        ...
        rv_travelling.setAdapter(adapter_traveling);
